...
public interface HouseMapper {
	...
	// 锟斤拷锟捷凤拷锟斤拷锟斤拷锟酵诧拷询 筛选锟斤拷品锟狡癸拷寓 锟斤拷锟� HOUSESET_TYPE_FK=3
	// 锟斤拷取锟斤拷锟叫的凤拷锟斤拷锟叫憋拷;
	...
	// 锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟轿拷锟斤拷锟斤拷朔锟斤拷锟� 锟斤拷示锟斤拷锟斤拷锟斤拷息锟斤拷锟斤拷页锟斤拷锟斤拷
	// HOUSESET_TYPE_FK=3
