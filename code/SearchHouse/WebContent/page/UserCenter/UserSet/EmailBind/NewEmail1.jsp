...
<div id="phonebind-div">
    <ul id="contenttitle-ul">
        ...
        <li class="content-li"><span class="step-style">2</span>&nbsp;绑定邮箱</li>
...
<div id="phone-step-1" class="col-md-8">
    ...
    <form  action="NewEmail2.jsp" class="form-horizontal ">
<div class="form-group">
        <div class="form-inline">
            <label for="oldphone" class="col-sm-2 control-label">原邮箱地址</label>
            <div class="col-md-2">
                <input type="text" style="width: auto;" name="emailTo" class="form-control col-md-2" id="oldmail" value="${user.userMail}" disabled="disabled">
