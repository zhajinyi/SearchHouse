...
<div id="phonebind-div">
    <ul id="contenttitle-ul">
        ...
        <li class="content-li"style="color: #e96c1f"><span class="step-style"style="color: #e96c1f">2</span>&nbsp;绑定邮箱</li>
...
<div class="form-group">
        <div class="form-inline">
            <label for="newmail" class="col-sm-2 control-label">新邮箱地址</label>
            <div class="col-md-2">
