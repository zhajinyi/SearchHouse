...
<div id="phonebind-div">
    <ul id="contenttitle-ul">
        ...
        <li class="content-li"><span >2</span>&nbsp;绑定手机</li>
...
<div id="phone-step-1">
    <span style="font-size: 25px">绑定成功！<span id="mes">5</span>秒后转至个人中心。<a href="${pageContext.request.contextPath}/page/UserCenter/UserSet/UserData.jsp">立即跳转</a></span>
