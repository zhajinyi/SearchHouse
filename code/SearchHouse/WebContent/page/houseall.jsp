...
<section id="property-listing">
    <header class="section-header text-center">
        <div class="container">
            <h2 class="pull-left" style="color:#FFCC99">全部房源</h2>
    ...
    <div class="container section-layout">
        ...
        <ul id="pagination" class="text-center clearfix">
         ...
         <li><a href="/SearchHouse/houseall?pageNo=1">首页</a></li>
				<li><a href='/SearchHouse/houseall?pageNo=
				...
				<li><a href="/SearchHouse/houseall?pageNo=${page.totalPage }">尾页</a></li>
				...
				<li class="li1">
					<form action="/SearchHouse/houseall" onsubmit="return check()">
