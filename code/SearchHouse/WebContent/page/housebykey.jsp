...
<section id="property-listing">
    <header class="section-header text-center">
        <div class="container">
            <h2 class="pull-left" style="color:#FFCC99">查询列表</h2>
            <h4 class="pull-left" id="shouye"><a href="${pageContext.request.contextPath}/index">首页</a></h4>
            <h4 class="pull-left" id="quanbu"><a href="${pageContext.request.contextPath}/houseall?pageNo=1">全部房源</a></h4>
            <h4 class="pull-left" id="pingpai"><a href="${pageContext.request.contextPath}/houseType?pageNo=1">品牌公寓</a></h4>       
        </div>
    </header>
    <div class="container section-layout">
        ...
        <ul id="pagination" class="text-center clearfix">
             <li><a href="/SearchHouse/getHouseByKey?pageNo=1&keyName=${kname }" >首页</a></li>
				<li><a href='/SearchHouse/getHouseByKey?keyName=${kname }&pageNo=
				...
				<li><a href="/SearchHouse/getHouseByKey?keyName=${kname }&pageNo=${page.totalPage }">尾页</a></li>
				...
				<li class="li1">
					<form action="/SearchHouse/getHouseByKey" onsubmit="return check()">
					              <input type="hidden" name="keyName" value="${kname }">
