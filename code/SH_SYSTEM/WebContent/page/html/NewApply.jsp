...
<div class="sidebar-nav">
   ...
   <!--  <a href="#msg-menu" class="nav-header" data-toggle="collapse"><i class="icon-briefcase"></i>消息管理</a>
    <ul id="msg-menu" class="nav nav-list collapse">
        <li><a href="#">用户建议</a></li>
        <li><a href="#">用户提问</a></li>
    </ul> -->
            ...
            <div class="well">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th width="100" style="text-align: center;">房屋价格</th>
                        <th width="100" style="text-align: center;">审核状态</th>
                    ...
                    <a data-toggle="modal" data-target="#details" onclick="showdetails(${house.houseId})" >查看详情</a></td>
                    <td style="text-align: center;">
                    <a href="${pageContext.request.contextPath}/updateHouse?houseId=${house.houseId}" onclick="sendmsg('${house.user.userId }','${house.houseName}','${house.user.userMail}')" ><i class="icon-ok" style="width: 11px"></i></a>
                    <span>&nbsp;||&nbsp;</span>
                    
                    <!-- <a href="${pageContext.request.contextPath}/unchecked?houseId=${house.houseId}"><i class="icon-remove" style="width: 11px" data-toggle="modal"></i></a> -->
                    <input type="hidden" value="${house.houseName}" id="name11"/>
                    <input type="hidden" value="${house.user.userMail}" id="email12"/>
                ...
                function sendmsg(userId,houseName,email){
                if(email!=null){
                var xmlhttp = new XMLHttpRequest();
                var emailTo =email;
                var tittle="【搜趣房】房屋审核信息";
                var content=userId+",您所申请的"+houseName+"已经审核通过";
...
function sendmail(){
    ...
    if(emailTo!=null){
     ...
     var tittle="【搜趣房】房屋审核信息";
     var content=userId+",您所申请的"+housename+",由于："+reason+",审核未通过,请您及时登录搜趣房进行修改！";
     xmlhttp.open("GET","${pageContext.request.contextPath}/sendmail?emailTo="+emailTo+"&tittle="+tittle+"&content="+content, true);
     xmlhttp.send();
     } 
    
    window.location.href="${pageContext.request.contextPath}/unchecked?houseId="+userId;
     }
